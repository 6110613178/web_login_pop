...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 09, 2021 at 10:18 AM
...
INSERT INTO `bts` (`id`, `name`) VALUES
(1, 'สุขุมวิท'),
(2, 'สีลม');
...
(1, 'บ้าน', 'บ้านเดี่ยว', 'LnH', 'มือ 1', 2, 3, 2, 1, 1, 1, 'ครบ', 100, 200, 100, 200, '56', 'Ramindra', 'ท่าแร้ง', 'เขตบางเขน', '1', 'โรงเรียน', 500000, 5000000, '2021-07-09 00:56:54', '2021-07-09 00:56:54');
...
(6, '2021_06_24_085203_buyer_prop_crud', 4);
...
INSERT INTO `mrt` (`id`, `name`) VALUES
(3, 'สายเฉลิมรัชมงคล(สายสีน้ำเงิน)'),
(4, 'สายฉลองรัชธรรม(สายสีม่วง)');
...
--
-- Dumping data for table `sub_bts`
--

INSERT INTO `sub_bts` (`id`, `name`, `station_code`, `type`) VALUES
(1, 'คูคต', 'N24', 1),
(2, 'แยก คปอ.', 'N23', 1),
(3, 'พิพิธภัณฑ์กองทัพอากาศ', 'N22', 1),
(4, 'โรงพยาบาลภูมิพลอดุลยเดช', 'N21', 1),
(5, 'สะพานใหม่', 'N20', 1),
(6, 'สายหยุด', 'N19', 1),
(7, 'พหลโยธิน 59', 'N18', 1),
(8, 'วัดพระศรีมหาธาตุ', 'N17', 1),
(9, 'กรมทหารราบที่ 11', 'N16', 1),
(10, 'บางบัว', 'N15', 1),
(11, 'กรมป่าไม้', 'N14', 1),
(12, 'มหาวิทยาลัยเกษตรศาสตร์', 'N13', 1),
(13, 'เสนานิคม', 'N12', 1),
(14, 'รัชโยธิน', 'N11', 1),
(15, 'พหลโยธิน 24', 'N10', 1),
(16, 'ห้าแยกลาดพร้าว', 'N9', 1),
(17, 'หมอชิต', 'N8', 1),
(18, 'สะพานควาย', 'N7', 1),
(19, 'เสนาร่วม', 'N6', 1),
(20, 'อารีย์', 'N5', 1),
(21, 'สนามเป้า', 'N4', 1),
(22, 'อนุสาวรีย์ชัยสมรภูมิ', 'N3', 1),
(23, 'พญาไท', 'N2', 1),
(24, 'ราชเทวี', 'N1', 1),
(25, 'สยาม', 'CEN', 1),
(26, 'ชิดลม', 'E1', 1),
...
(40, 'สำโรง', 'E15', 1),
(41, 'ปู้เจ้า', 'E16', 1),
(42, 'ช้างเอราวัณ', 'E17', 1),
(43, 'โรงเรียนนายเรือ', 'E18', 1),
(44, 'ปากน้ำ', 'E19', 1),
(45, 'ศรีนครินทร์', 'E20', 1),
(46, 'แพรกษา', 'E21', 1),
(47, 'สายลวด', 'E22', 1),
(48, 'เคหะฯ', 'E23', 1),
(49, 'สนามกีฬาแห่งชาติ', 'W1', 2),
(50, 'สยาม', 'CEN', 2),
(51, 'ราชดำริ', 'S1', 2),
(52, 'ศาลาแดง', 'S2', 2),
(53, 'ช่องนนทรี', 'S3', 2),
...
(61, 'วุฒากาศ', 'S11', 2),
(62, 'บางหว้า', 'S12', 2),
(63, 'ท่าพระ(จรัญสนิทวงศ์)', 'BL01', 3),
(64, 'จรัญฯ 13', 'BL02', 3),
(65, 'ไฟฉาย', 'BL03', 3),
(66, 'บางขุนนนท์', 'BL04', 3),
(67, 'บางยี่ขัน', 'BL05', 3),
(68, 'สิรินธร', 'BL06', 3),
(69, 'บางพลัด', 'BL07', 3),
(70, 'บางอ้อ', 'BL08', 3),
...
(73, 'บางซื่อ', 'BL11', 3),
(74, 'กำแพงเพชร', 'BL12', 3),
(75, 'สวนจตุจักร', 'BL13', 3),
(76, 'พหลโยธิน', 'BL14', 3),
(77, 'ลาดพร้าว', 'BL15', 3),
(78, 'รัชดาภิเษก', 'BL16', 3),
(79, 'สุทธิสาร', 'BL17', 3),
(80, 'ห้วยขวาง', 'BL18', 3),
(81, 'ศูนย์วัฒนธรรมแห่งประเทศไทย', 'BL19', 3),
(82, 'พระราม 9', 'BL20', 3),
(83, 'เพชรบุรี', 'BL21', 3),
(84, 'สุขุมวิท', 'BL22', 3),
(85, 'ศูนย์การประชุมแห่งชาติสิริกิติ์', 'BL23', 3),
(86, 'คลองเตย', 'BL24', 3),
(87, 'ลุมพินี', 'BL25', 3),
(88, 'สีลม', 'BL26', 3),
(89, 'สามย่าน', 'BL27', 3),
...
(93, 'สนามไชย', 'BL31', 3),
(94, 'อิสรภาพ', 'BL32', 3),
(95, 'ท่าพระ(เพชรเกษม)', 'BL01', 3),
(96, 'บางไผ่', 'BL33', 3),
(97, 'บางหว้า', 'BL34', 3),
(98, 'เพชรเกษม 48', 'BL35', 3),
(99, 'ภาษีเจริญ', 'BL36', 3),
(100, 'บางแค', 'BL37', 3),
(101, 'หลักสอง', 'BL38', 3),
(102, 'คลองบางไผ่', 'PP01', 4),
(103, 'ตลาดบางใหญ่', 'PP02', 4),
(104, 'สามแยกบางใหญ่', 'PP03', 4),
(105, 'บางพลู', 'PP04', 4),
(106, 'บางรักใหญ่', 'PP05', 4),
(107, 'บางรักน้อย-ท่าอิฐ', 'PP06', 4),
(108, 'ไทรม้า', 'PP07', 4),
(109, 'สะพานพระนั่งเกล้า', 'PP08', 4),
(110, 'แยกนนทบุรี 1', 'PP09', 4),
(111, 'บางกระสอ', 'PP10', 4),
(112, 'ศูนย์ราชการนนทบุรี', 'PP11', 4),
(113, 'กระทรวงสาธารณสุข', 'PP12', 4),
(114, 'แยกติวานนท์', 'PP13', 4),
(115, 'วงศ์สว่าง', 'PP14', 4),
(116, 'บางซ่อน', 'PP15', 4),
(117, 'เตาปูน', 'PP16', 4);
...
(5, 'Mario', 'Mario@hotmail.com', NULL, NULL, '$2y$10$x8HGoemU/sn09kkU3KDdtOSMjgkqBvP79pui8Y0LTkxujiU/EaKDO', NULL, '2021-06-22 22:34:38', '2021-06-22 22:34:38'),
(6, 'Doraemon1', 'dorae1@hotmail.com', NULL, NULL, '$2y$10$UrujK7T8cdkormSVZEBjueWXxV8dxoM0WMNNsixInjBN3IOSM7a5a', NULL, '2021-06-22 22:49:35', '2021-06-22 22:49:35');
