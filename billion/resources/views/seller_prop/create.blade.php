                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('seller_prop.store') }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="tranfer_date" type="number" class="form-control" name="tranfer_date" placeholder="Tranfer Date" min="0">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="ownership_document" type="text" class="form-control" name="ownership_document" placeholder="Ownership Document">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nearby_bts" type="text" class="form-control" name="nearby_bts" placeholder="Nearby BTS">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nearby_airport_link" type="text" class="form-control" name="nearby_airport_link" placeholder="Nearby Airport Link">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nearby_mrt" type="text" class="form-control" name="nearby_mrt" placeholder="Nearby MRT">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="property_picture" type="text" class="form-control" name="property_picture" placeholder="Property Picture">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="floor_plan_picture" type="text" class="form-control" name="floor_plan_picture" placeholder="Floor Plan Picture">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="property_video" type="text" class="form-control" name="property_video" placeholder="Property Video">
